                ...
                <div className="page-group">
                    <div className="page ">
                        <header className="bar bar-nav">
                            <a className="icon icon-me pull-left open-panel"/>
                            {
                                            ...
                                            <div key={i}>
                                                <div className="card facebook-card" >
                                                    ...
                                                    <div className="card-content" onClick={() => {
                                                        this.props.history.push({ pathname: "/friend/details", state: v })
                                                    }}>
...
export default withRouter( connect(mapStateToProps, mapDispatchToprops)(Dongtai) )